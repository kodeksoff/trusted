...
')
     ...
     */ 
         ...
         * 
         *
         * @return \App\Services\CategoryBuilder\CategoryService 
         * @static 
         */ 
        public static function instance()
        {
                        return \App\Services\CategoryBuilder\CategoryService::instance();
        }
                    /**
         * 
         *
         * @param \App\Http\Controllers\TestController $controller
         * @param $path
         * @return \Illuminate\Contracts\Foundation\Application|\Illuminate\Contracts\View\Factory|\Illuminate\Contracts\View\View 
         * @static 
         */ 
        public static function resolver($controller, $path)
        {
                        /** @var \App\Services\CategoryBuilder\CategoryService $instance */
                        return $instance->resolver($controller, $path);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function transfer($controller)
        {
                        /** @var \App\Services\CategoryBuilder\CategoryService $instance */
                        return $instance->transfer($controller);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\CategoryBuilder\CategoryService $instance */
                        return $instance->getCurrentCategory();
        }
...
namespace  { 
            ...
            class Categories extends \App\Facades\Categories {}
